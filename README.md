...
| [hl2guide's list](https://github.com/xarantolus/filtrite/releases/latest/download/hl2guide-extreme.dat) | This list is based on [hl2guide's filterlist](https://github.com/hl2guide/Filterlist-for-AdGuard-or-PiHole), which might block more than you want it to |
