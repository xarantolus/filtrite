...
| [German](https://github.com/hmtheboy154/filtrite/releases/latest/download/vietnam.dat) | The "Bromite Extended" list with additional region-specific blocklists for german sites |
| [Vietnam](https://github.com/hmtheboy154/filtrite/releases/latest/download/vietnam.dat) | The "Bromite Extended" list with additional region-specific blocklists for Vietnam sites (Thanks @ABPVN for the list) |
