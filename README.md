...
| [Bromite Extended](https://github.com/hayaburro/filtrite/releases/latest/download/eadu.dat) | The default list with additional annoyance blockers I use with [uBlock Origin](https://github.com/gorhill/uBlock) on Desktop |
